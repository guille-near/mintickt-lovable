  ...
  return (
    <div className="flex flex-col items-center space-y-6">
      <div className="relative">
        ...
        {walletAddress && (
          <div className="absolute -bottom-2 -right-1 h-10 w-10">
            <img
      ...
      {isOwnProfile && (
        <div className="flex items-center gap-2">
          <Button variant="outline" size="icon" className="border border-input h-9 w-9">
            <QRCodeDialog profileUrl={profileUrl} />
          </Button>
          <Button variant="outline" asChild className="border border-input h-9">
