...
export default function EventDetails() {
  ...
  if (eventLoading) {
    return (
      <div className="min-h-screen flex flex-col dark:bg-[linear-gradient(125deg,#FF00E5_5%,transparent_15%)] dark:bg-black">
        <SimpleHeader />
  ...
  return (
    <div className="flex flex-col min-h-screen dark:bg-[linear-gradient(125deg,#FF00E5_5%,transparent_15%)] dark:bg-black">
      <SimpleHeader />
